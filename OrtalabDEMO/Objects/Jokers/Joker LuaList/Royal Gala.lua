...
royal_gala.calculate = function(self, context) --Royal Gala Logic
	if self.ability.name == 'Royal Gala' then
		...
		if SMODS.end_calculate_context(context) then
			if not G.localization.misc.v_dictionary_parsed['a_xchips'] then G.localization.misc.v_dictionary_parsed['a_xchips'] = loc_parse_string(G.localization.misc.v_dictionary.a_xchips) end
			return {
